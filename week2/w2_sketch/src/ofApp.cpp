...
//    ofSetLineWidth(3);
//    for(int i = 0; i < mfcc_bands.size(); i++){
//        line2.lineTo(i * mfccBandWidth,
//                    ofGetHeight() + (-ofMap(mfcc_bands[i]/rms, 0, 1.0, 0, ofGetHeight(), true)*bandsNoveltyFactor.get()));
//    }
    ...
    for(int i = 0; i < mfcc_bands.size(); i++){
        ...
        ofDrawLine(i*mfccBandWidth, ofMap(mfcc_bands[i]/rms, 0, 1.0, ofGetHeight()/2, ofGetHeight(), true)*bandsNoveltyFactor.get(), 0, 0);
        ofDrawLine(i*mfccBandWidth, ofMap(mfcc_bands[i]/rms, 0, 1.0, ofGetHeight()/2, ofGetHeight(), true)*bandsNoveltyFactor.get(), ofGetWidth(), ofGetHeight());
        ofDrawLine(i*mfccBandWidth, ofMap(mfcc_bands[i]/rms, 0, 1.0, ofGetHeight()/2, ofGetHeight(), true)*bandsNoveltyFactor.get(), ofGetWidth(), 0);
        ofDrawLine(i*mfccBandWidth, ofMap(mfcc_bands[i]/rms, 0, 1.0, ofGetHeight()/2, ofGetHeight(), true)*bandsNoveltyFactor.get(), 0, ofGetHeight());
